...
app.get("/api/facebook", async (req, res) => {
    ...
    const url = `https://graph.facebook.com/v18.0/${pageId}/posts?fields=id,message,created_time,permalink_url,attachments{media,subattachments{media}}&limit=25&access_token=${accessToken}`;
